...
if (isset($_POST['zmist']))
	{
		...
		$zam = '<td height="15" colspan="2"><img src="http://www.bohdan-books.com/img/spacer.gif" width="15" height="15" /></td>';
		$na = '';
...
", " ", $zmist);
        ...
        $fp = fopen("rozsylka.html", "w+"); // Открываем файл в режиме записи
        $test = fwrite($fp, $zmist); // Запись в файл
...
<form action="view.php" method="post" target="_new" style="text-align:center;  margin-left:auto; margin-right:auto;">
  ...
  <a href="rozsylka.html" download><input type="button" value="Завантажити"></a>
</form>
