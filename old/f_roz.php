...
<div id="page">
    ...
    <!-- Початок Тіла сайту -->    
		<div class="post">
			<h1 class="title">Створення розсилки</h1>
...
?>
<form action="f_roz.php" method="post" style="text-align:center;  margin-left:auto; margin-right:auto;">
